...
define(['underscore'], function (_) {
    return function () {
        ...
        function Modal(id, options) {
            ...
            if (modalOptions.center) {
                $(".modal-content", this.$el).css("text-align", "center");
                $(".modal-title", this.$el).css("padding-right", "0");
            }
            ...
            if (modalOptions.button) {
                var title;
                if (modalOptions.button === true) {
                    title = "OK";
                }
                else {
                    title = modalOptions.button;
                }
                this.footer.append($('<button>' + title + '</button>').attr({
                    type: 'button',
                    'data-dismiss': 'modal',
